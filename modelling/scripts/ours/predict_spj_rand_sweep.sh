...
function do_predictions_ssg_spj() {
  ...
  python3 src/neuraldb/convert_spj_to_predictions.py work/${dataset2}/$model_path/intermediate_predictions.jsonl work/${dataset2}/$model_path/predictions.jsonl --actual_file resources/${dataset2}/test.jsonl
}
